...
import type { UdhaarEntry, SyncStatus, BillItem } from '../types/entities.js'
...
export async function addUdhaar(
  ...
  const result = await query(
    `INSERT INTO udhaar (business_id, customer_id, amount, description, due_date, items, remaining_amount, sync_status, version)
     VALUES ($1, $2, $3, $4, $5, $6, $3, 'pending', 1)
     RETURNING *`,
    [businessId, customerId, amount, description, dueDate || null, itemsJson]
  )
