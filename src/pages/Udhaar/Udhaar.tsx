...
import { saveProducts } from '../../data/services/savedProducts'
...
import type { Customer, UdhaarEntry, BillItem } from '../../core/types'
        ...
        <div className="space-y-5">
          ...
          <div>
            <div className="mb-2 flex items-center justify-between">
              <label htmlFor="udhaar-description" className="block text-sm font-semibold text-ink-light">Description</label>
            </div>
            <input
          ...
          <div className="flex flex-col-reverse gap-3 pt-1 sm:flex-row sm:justify-end">
            ...
            <Button
              ...
              disabled={!customerId || !description.trim() || (!amount && !hasValidItems(items)) || isSubmitting}
