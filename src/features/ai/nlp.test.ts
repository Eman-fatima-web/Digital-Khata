...
describe('detectGreeting', () => {
  ...
  it('detects Roman Urdu greetings', () => {
    expect(detectGreeting('kia hal he')).toBe(true)
    expect(detectGreeting('kya haal hai')).toBe(true)
    expect(detectGreeting('salam bhai')).toBe(true)
    expect(detectGreeting('assalamo alaikum')).toBe(true)
    expect(detectGreeting('kaise ho')).toBe(true)
    expect(detectGreeting('adaab')).toBe(true)
  })
})

describe('detectMessageLanguage', () => {
  it('returns ur for Roman Urdu', () => {
    expect(detectMessageLanguage('kia hal he')).toBe('ur')
    expect(detectMessageLanguage('yr mujhe khata khulwana he apna')).toBe('ur')
    expect(detectMessageLanguage('kia ap help kr skte he meri')).toBe('ur')
    expect(detectMessageLanguage('mera balance kitna hai')).toBe('ur')
  })

  it('returns ur-script for Urdu script', () => {
    expect(detectMessageLanguage('میرا بیلنس کتنا ہے')).toBe('ur-script')
    expect(detectMessageLanguage('سلام')).toBe('ur-script')
  })

  it('returns en for English', () => {
    expect(detectMessageLanguage('hello')).toBe('en')
    expect(detectMessageLanguage('how are you')).toBe('en')
    expect(detectMessageLanguage('Ahmed balance')).toBe('en')
